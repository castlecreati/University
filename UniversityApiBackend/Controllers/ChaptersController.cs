    ...
    public class ChaptersController : ControllerBase
    {
        ...
        public async Task<ActionResult<Chapter>> GetChapter(int id)
        {
          if (_context.Chapters == null)
          {
            ...
            var capitulo = await _context.Chapters.FindAsync(id);
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<Chapter>> PostChapter(Chapter capitulo)
        {
          if (_context.Chapters == null)
          {
              return Problem("Entity set 'UniversityDBContext.Capitulos'  is null.");
          }
            _context.Chapters.Add(capitulo);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteChapter(int id)
        {
            ...
            _context.Chapters.Remove(capitulo);
            await _context.SaveChangesAsync();
